...
export const gridOrderStatus = (props) => {
  ...
  const backgroundColor = statusColors[status] || 'gray'; // Default to gray if status is not found
...
export const ordersData = [
  ...
  },
  {
    ...
    TotalAmount: 23.99,
    BookingItems: 'Healthcare Erbology',
    Location: 'Spain',
    Status: 'rejected',
    StatusBg: 'red',
    ProductImage:
  ...
  },
  {
    ...
    TotalAmount: 95.99,
    BookingItems: 'Makeup Lancome Rouge',
    Location: 'USA',
    Status: 'canceled',
    StatusBg: '#FF5C8E',
    ProductImage:
